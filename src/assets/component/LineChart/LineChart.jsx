...
const LineChart = () => {
    ...
    const gymStudentData = [
        ...
        { id: 6, name: "Frank", body_strength: 66, muscle_strength: 75, foot_strength: 88 },
        ...
        { id: 12, name: "Leo", body_strength: 68, muscle_strength: 78, foot_strength: 87 },
        ...
        { id: 20, name: "Tyler", body_strength: 69, muscle_strength: 94, foot_strength: 82 }
    ];
    return (
            ...
            <div className='lg:w-[1000px] md:w-[600px] mx-auto'>
                ...
                <div className='flex justify-center'>
                    {/* <ResponsiveContainer width="100%" height="100%"> */}
                        <BarChart width={1100} height={400} data={gymStudentData}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis dataKey={'name'} ></XAxis>
                            <YAxis ></YAxis>
                            <Tooltip></Tooltip>
                            <Legend></Legend>
                            <Bar dataKey={'body_strength'} stroke='red' fill="#8884d8"></Bar>
                            <Bar dataKey={'muscle_strength'} stroke='green' ></Bar>
                            <Bar dataKey={'foot_strength'} stroke='blue' fill="#82ca9d"></Bar>
                        </BarChart>
                    {/* </ResponsiveContainer> */}
